...
| （New）折り畳みを有効にする | 任意 | チェックを入れると折り畳み表示が可能になります。 |

## （New）折り畳み表示

リンクが増えてきたときに「縦に長くなりすぎる問題」を解消するため、折り畳み表示に対応しました。

### コンポーネントのイメージ

- 折り畳みが閉じている場合

![閉じている場合](/docs/collapse_collapsed.png)

- 折り畳みが開いている場合

![開いている場合](/docs/collapse_expanded.png)
